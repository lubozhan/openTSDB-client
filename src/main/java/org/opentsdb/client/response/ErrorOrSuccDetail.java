 ...
 */
public class ErrorOrSuccDetail {
    private List<ErrorDetailEntity> errors;

    private Integer success;
    private Integer failed;

    public ErrorOrSuccDetail(List<ErrorDetailEntity> errors) {
        this.errors = errors;
    }

    public ErrorOrSuccDetail(Integer success, Integer failed) {
    ...
    public ErrorOrSuccDetail(ErrorDetailEntity error) {
